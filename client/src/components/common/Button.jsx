...
export function Button({ 
  ...
  const variants = {
    ...
    outline: 'border border-[var(--border-color)] bg-transparent hover:bg-slate-50 dark:hover:bg-slate-800/50 text-[var(--text-primary)] focus:ring-slate-500',
    danger: 'bg-red-600 hover:bg-red-700 text-white shadow-sm focus:ring-red-500',
    ghost: 'bg-transparent hover:bg-slate-100 dark:hover:bg-slate-800 text-[var(--text-primary)]'
  };
